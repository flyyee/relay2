...
function createPostgresSubscriber(connectionConfig, options) {
    ...
    return {
        ...
        listenTo: function (channelName) {
            ...
            subscribedChannels = subscribedChannels.concat([channelName]);
        ...
        unlisten: function (channelName) {
            ...
            subscribedChannels = subscribedChannels.filter(function (someChannel) { return someChannel !== channelName; });
